...
namespace TrueSync {
    ...
    public partial struct FP : IEquatable<FP>, IComparable<FP> {
        ...
        public static readonly FP Quarter = FP.Half * FP.Half;
        public static readonly FP Eighth = FP.Half * FP.Half * FP.Half;
        ...
        public static readonly FP EpsilonSqt = FP.EN3 * FP.EN3;

        public static readonly FP FPS_60 = FP.One / 60;
        public static readonly FP FPS_30 = FP.One / 30;
        public static readonly FP FPS_24 = FP.One / 24;
